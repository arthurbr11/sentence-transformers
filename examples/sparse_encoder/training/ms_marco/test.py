...
mlm_transformer = MLMTransformer(model_name, trust_remote_code=True)
...
model = SparseEncoder(
    ...
    model_card_data=SparseEncoderModelCardData(
        language="en",
        license="apache-2.0",
        model_name="SPLADE xlm-roberta-large trained on MS MARCO triplets",
    ),
)
